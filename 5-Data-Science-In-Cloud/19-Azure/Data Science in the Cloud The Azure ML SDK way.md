...
In the [previous lesson](Data%20Science%20in%20the%20Cloud%20The%20Low%20code%20No%20code%20way.md), we saw how to train, deploy and consume a model in a Low code/No code fashion. We used the Heart Failure dataset to generate and Heart failure prediction model. In this lesson, we are going to do the exact same thing but using the Azure Machine Learning SDK.

![project-schema](images/project-schema.PNG)

### 1.2 Heart failure prediction project and dataset introduction

Check [here](Data%20Science%20in%20the%20Cloud%20The%20Low%20code%20No%20code%20way.md) the Heart failure prediction project and dataset introduction.
...
If not, please follow the instructions in the section **2.1 Create an Azure ML workspace** in the [previous lesson](Data%20Science%20in%20the%20Cloud%20The%20Low%20code%20No%20code%20way.md) to create a workspace.
...
Refer the [previous lesson](Data%20Science%20in%20the%20Cloud%20The%20Low%20code%20No%20code%20way.md) in the section **2.3 Loading the Dataset** if you have not uploaded the dataset yet.
