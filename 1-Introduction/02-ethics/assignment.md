...
You've learned about various [Data Ethics Challenges](Introduction%20to%20Data%20Ethics.md#2-ethics-challenges) and seen some examples of [Case Studies](Introduction%20to%20Data%20Ethics.md#3-case-studies) reflecting data ethics challenges in real-world contexts.
...
1. `Pick a Data Ethics Challenge`. Look at [the lesson examples](Introduction%20to%20Data%20Ethics.md#2-ethics-challenges) or explore online examples like [the Deon Checklist](https://deon.drivendata.org/examples/) to get inspiration.
